...
export enum OrgainzationType {
    ...
    CULTURAL_ORGANIZATIONS = "Public cultural organizations",
...
export class OrganizationProfile implements Organization {
    ...
    @Expose({groups: ['internal', 'private', 'public', 'database_preservable']})
    surname?: string;
    @Expose({groups: ['internal', 'private', 'public', 'database_preservable']}) @Transform(({obj, key}) => (obj[key] != null) ? "ORGANIZATION" : undefined)
